    ...
    <div className="relative flex items-center justify-center">
      ...
      >
        <input
          ...
          className="absolute top-16 right-0  md:relative md:top-0 lg:text-[18px] text-[16px] md:py-1 bg-transparent focus:outline-none focus:border-b md:px-5 lg:px-10 transition-opacity duration-300 ease-in-out"
        />
